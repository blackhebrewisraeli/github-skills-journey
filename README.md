...
|---|----------|----------------|------------|
| 1 | **Introduction to GitHub** | Repositories, branches, commits, and pull requests — the core GitHub workflow. | [`skills-introduction-to-github`](https://github.com/blackhebrewisraeli/skills-introduction-to-github) |
| 2 | **Introduction to Git** | Cloning, staging, committing, and pushing from the command line. | [`skills-introduction-to-git`](https://github.com/blackhebrewisraeli/skills-introduction-to-git) |
| 3 | **Communicate using Markdown** | Formatting issues, PRs, and docs with headings, lists, links, tables, and code blocks. | [`skills-communicate-using-markdown`](https://github.com/blackhebrewisraeli/skills-communicate-using-markdown) |
...
- **Version control fundamentals** — branching, committing, merging, and a clean history.
...
<sub>Maintained by [@blackhebrewisraeli](https://github.com/blackhebrewisraeli) · Built as part of my GitHub Foundations preparation.</sub>
